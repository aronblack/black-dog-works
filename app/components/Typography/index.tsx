...
export function Heading1({ as: Tag = 'h1', className, ...props }: Heading1Props) {
  return (
    <Tag
      className={cn('font-[family-name:var(--font-bebas-neue)] text-4xl font-normal tracking-tight md:text-6xl', className)}
      {...(props as object)}
    />
  )
}
...
export function Heading2({ as: Tag = 'h2', className, ...props }: Heading2Props) {
  return (
    <Tag
      className={cn('font-[family-name:var(--font-bebas-neue)] text-3xl font-normal md:text-4xl', className)}
      {...(props as object)}
    />
  )
}
...
export function Heading3({ as: Tag = 'h3', className, ...props }: Heading3Props) {
  return (
    <Tag
      className={cn('font-[family-name:var(--font-bebas-neue)] text-xl font-normal', className)}
      {...(props as object)}
    />
  )
}
...
export function Eyebrow({ as: Tag = 'p', className, ...props }: EyebrowProps) {
  return (
    <Tag
      className={cn(
        'font-[family-name:var(--font-bebas-neue)] text-xs font-normal uppercase tracking-widest text-neutral-500 dark:text-neutral-400',
        className,
      )}
      {...(props as object)}
    />
...
export function Body({ as: Tag = 'p', className, ...props }: BodyProps) {
  return (
    <Tag
      className={cn('font-[family-name:var(--font-manrope)] text-base font-normal leading-7', className)}
      {...(props as object)}
    />
  )
}
...
export function BodySmall({ as: Tag = 'p', className, ...props }: BodySmallProps) {
  return (
    <Tag
      className={cn('font-[family-name:var(--font-manrope)] text-sm font-normal leading-6', className)}
      {...(props as object)}
    />
  )
}
...
export function LabelTypo({ as: Tag = 'span', className, ...props }: LabelTypoProps) {
  return (
    <Tag
      className={cn('font-[family-name:var(--font-manrope)] text-sm font-medium', className)}
      {...(props as object)}
    />
  )
}
